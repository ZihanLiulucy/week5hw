...
library(tmap)
library(dplyr)
report <- read_csv("C:/Users/10414/Desktop/ucl/CASA0005/week2 homework/Report_Card_Assessment_Data_2018-19_School_Year_20231016.csv", na = "NULL")
shape <- st_read ("C:/Users/10414/Desktop/ucl/CASA0005/week2 homework/washington/Washington_Counties_with_Natural_Shoreline___washsh_area.shp")
Datatypelist <- report %>% 
  summarise_all(class) %>%
